...
import { TrainingsPlanModel } from '../trainingsplan/TrainingsPlanModel';
import CompletedTaskModel from './CompletedTaskModel';
import { addPoints } from '../user/UserService';
