		...
		<PixelCard>
			...
			<PixelCardContent className="flex flex-col gap-4">
				...
				<div className="grid grid-cols-2 gap-3">
					<div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/40 dark:to-emerald-800/40 border-2 border-black dark:border-white/20 p-3 text-center">
						<div className="text-2xl font-bold text-black dark:text-white">{weekData.completedWorkouts}</div>
						<div className="text-xs text-black/60 dark:text-white/60">Workouts</div>
					</div>
				...
				<div className="flex justify-between gap-1 mt-auto">
					{weekData.dayStatus.map((day) => (
						<div key={day.day} className="flex flex-col items-center gap-1">
							<span className="text-[10px] text-black/50 dark:text-white/50 font-medium">{day.day}</span>
							<div
