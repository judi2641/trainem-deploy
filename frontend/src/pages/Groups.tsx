...
export default function Groups() {
	return (
		<div className="relative flex h-screen overflow-hidden bg-gradient-to-br from-[#CFEFE3] via-[#E2F6EE] to-[#FFE8B0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
			...
			{/* Glow effects */}
			<div className="absolute -top-40 -left-40 h-[420px] w-[420px] rounded-full bg-purple-300/30 dark:bg-purple-500/10 blur-3xl" />
			<div className="absolute -bottom-32 -right-32 h-[380px] w-[380px] rounded-full bg-blue-300/35 dark:bg-blue-500/10 blur-3xl" />

			{/* Pixel background */}
			<PixelBackground count={100} seed={84} />
