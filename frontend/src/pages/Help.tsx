						...
						<div className="relative">
							...
							<div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur border-4 border-black dark:border-white/20 p-6">
								...
								<form onSubmit={handleSubmit} className="space-y-4">
									...
									<div>
										<label className="block text-sm font-medium text-black dark:text-white mb-1" htmlFor="message">
											Message
										</label>
										<textarea
											id="message"
									...
									<div className="flex items-center gap-3">
										...
										{status === 'sent' && (
											<span className="text-sm text-emerald-600 dark:text-emerald-400">Thank you! We will reply soon.</span>
										)}
									</div>
								</form>
							</div>
