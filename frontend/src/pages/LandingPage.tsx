...
function Section({
  ...
  return (
    ...
    >
      ...
      <div className={fit ? "mx-auto max-w-6xl px-4 py-[clamp(18px,5vh,56px)] w-full" : "mx-auto max-w-6xl px-4 w-full"}>
        {children}
      </div>
    </section>
  );
    ...
    >
      ...
      <Section id="top" fit>
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <ShadowCard>
            ...
            <div className="mt-6 text-xs text-black/50 text-center">
      ...
      <Section id="faq" dark>
        <div className="text-center text-white">
          ...
          <div className="mt-16">
            <h3 className="text-3xl md:text-4xl font-semibold">Start today — make consistency visible.</h3>
